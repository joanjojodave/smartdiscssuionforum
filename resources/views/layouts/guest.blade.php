...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:flex-row">
            ...
            <!-- Branding panel -->
            <div class="hidden sm:flex sm:w-2/5 lg:w-1/3 bg-indigo-600 text-white flex-col justify-between p-10">
                ...
                <p class="text-xs text-indigo-200">&copy; {{ date('Y') }} Smart Discussion Forum &middot; Group 28, Makerere University CoCIS</p>
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center items-center px-6 py-10 bg-gray-50">
                ...
                <p class="mt-6 text-xs text-gray-400">Need an account? <a href="{{ route('register') }}" class="text-indigo-600 hover:underline">Sign up</a> &middot; <a href="{{ route('login') }}" class="text-indigo-600 hover:underline">Log in</a></p>
            </div>
        </div>
    </body>
</html>
